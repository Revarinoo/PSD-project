...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12 ">
        <p class="auto-style1 text-center">
            ...
            &nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnChangePassword" runat="server" class="btn btn-outline-info" Text="Change Password" OnClick="DoChangePassword"/>
            &nbsp;&nbsp;&nbsp;
    ...
    <asp:Button ID="btnViewTransactionReport" runat="server" class="btn btn-outline-info" Text="Transaction Report" OnClick="btnViewTransactionReport_Click" />
            ...
            <asp:Button ID="btnViewTransactionHistory" runat="server" class="btn btn-outline-info" Text="Transaction History" OnClick="btnViewTransactionHistory_Click"/>
